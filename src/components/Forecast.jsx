                ...
                data.slice(0,active.item).map((element,index)=> {
                    return (
                        <div className="weather-forecast__row" key={index}>
                            <span className="weather-forecast__day">{element.tempCelsius}</span>
                            <span className="weather-forecast__icon">
                                <i className="weather-forecast__icon">{element.tempCelsius}</i>
                            </span>
                            <span className="weather-forecast__high">{element.minCelsius} {unit}</span>
                            <span className="weather-forecast__low">{element.minCelsius} {unit}</span>
                        </div>
                    )
                    }
                )
